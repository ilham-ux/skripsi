...
<head>
    <meta charset="utf-8" />
    <title>Waroeng Group | Admin</title>
    <link rel="icon" href="<?php echo base_url(); ?>assets/img/logo/logo-only.png">
    ...
    <script src="<?php echo base_url(); ?>assets/plugins/chart-js/chartjs-plugin-datalabels-0.7.0/dist/chartjs-plugin-datalabels.js"></script>
    <!-- ================== END BASE JS ================== -->
</head>